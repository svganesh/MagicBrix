...
<div id="demo">
<h1 style="text-align:center;">PARADISE FINDER</h1>
  ...
  <div>
    <h3>Apartments near Arizona State University</h3>
  </div>
  ...
  <table id="table" class="table table-hover table-mc-light-blue" Style="display:block;">
      <thead>
        <tr>
          ...
          <th  style="padding: 0px 10px 0 10px;">Comments</th>
      ...
      %>
        <tr>
          ...
          <td data-title="yearBuilt" style="text-align: center;padding: 20px 0 0 0;"><%= details.optString("score")%></td>
          <td data-title="yearBuilt" style="text-align: center;padding: 20px 0 0 0;"><%= details.optString("comments")%></td>
  ...
  <h2 style=" margin-top: 7%;"> Refine your search? Please enter the location where you want the apartments to be suggested.</h2>
